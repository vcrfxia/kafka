...
public class KTableImpl<K, S, V> extends AbstractStream<K, V> implements KTable<K, V> {
    ...
    public KTableValueGetterSupplier<K, V> valueGetterSupplier() {
        if (processorSupplier instanceof KTableSource) {
            ...
            source.materialize();
            return new KTableSourceValueGetterSupplier<>(source.queryableName()); // TODO: add logic here to figure out whether the table should be versioned or not, and return value getter accordingly?
    ...
    private <VR, KO, VO> KTable<K, VR> doJoinOnForeignKey(final KTable<KO, VO> foreignKeyTable,
        ...
        final StoreBuilder<? extends TimestampedKeyValueStore<K, VR>> resultStore =
